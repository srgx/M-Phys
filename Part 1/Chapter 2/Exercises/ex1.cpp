...
int main(){
  ...
  // Real Middle
  assert(calculateMarkerPosition(TEXT_HEIGHT/2-WINDOW_HEIGHT/2,TEXT_HEIGHT,WINDOW_HEIGHT)==WINDOW_HEIGHT/2-MARKER_HEIGHT/2);
  assert(calculateTextPosition(WINDOW_HEIGHT/2-MARKER_HEIGHT/2,TEXT_HEIGHT,WINDOW_HEIGHT)==TEXT_HEIGHT/2-WINDOW_HEIGHT/2);

  // Middle
  assert(calculateMarkerPosition(TEXT_HEIGHT/2,TEXT_HEIGHT,WINDOW_HEIGHT)==WINDOW_HEIGHT/2);
  assert(calculateTextPosition(WINDOW_HEIGHT/2,TEXT_HEIGHT,WINDOW_HEIGHT)==TEXT_HEIGHT/2);
